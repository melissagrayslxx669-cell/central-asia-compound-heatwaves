...
INTERMEDIATE_CSV = os.path.join(OUT_DIR, "gsod_HWD_station_metrics_1950-2024_CA.csv")
...
def main():
    ...
    vmax_delta = float(np.percentile(vals_delta, 98)) if vals_delta.size > 0 else 1.0
    if vmax_delta <= 0:
        vmax_delta = 1.0
    ...
    vmax_trend = float(np.percentile(vals_trend, 98)) if vals_trend.size > 0 else 0.1
    if vmax_trend <= 0:
        vmax_trend = 0.1
    vmin_trend = -vmax_trend


    suptitle = "GSOD Heatwave Duration (HWD), UTC+05:00"
    ...
    plot_scatter_metric(
        ...
        out_png=os.path.join(OUT_DIR, "gsod_HWD_change_DL_1950-2024_CA_scatter.png"),
        out_pdf=os.path.join(OUT_DIR, "gsod_HWD_change_DL_1950-2024_CA_scatter.pdf"),
    )
    ...
    plot_scatter_metric(
        ...
        out_png=os.path.join(OUT_DIR, "gsod_HWD_trend_DL_1950-2024_CA_scatter.png"),
        out_pdf=os.path.join(OUT_DIR, "gsod_HWD_trend_DL_1950-2024_CA_scatter.pdf"),
        alpha_sig=0.05,
    )
    ...
    plot_scatter_metric(
        ...
        cbar_label="Change in annual mean HWD (days per year)",
        out_png=os.path.join(OUT_DIR, "gsod_HWD_change_NL_1950-2024_CA_scatter.png"),
        out_pdf=os.path.join(OUT_DIR, "gsod_HWD_change_NL_1950-2024_CA_scatter.pdf"),
    )
    ...
    plot_scatter_metric(
        ...
        cbar_label="Sen's slope of annual HWD (days per year)",
        out_png=os.path.join(OUT_DIR, "gsod_HWD_trend_NL_1950-2024_CA_scatter.png"),
        out_pdf=os.path.join(OUT_DIR, "gsod_HWD_trend_NL_1950-2024_CA_scatter.pdf"),
        alpha_sig=0.05,
    )
    ...
    plot_scatter_metric(
        ...
        cbar_label="Change in annual mean HWD (days per year)",
        out_png=os.path.join(OUT_DIR, "gsod_HWD_change_CL_1950-2024_CA_scatter.png"),
        out_pdf=os.path.join(OUT_DIR, "gsod_HWD_change_CL_1950-2024_CA_scatter.pdf"),
    )
    ...
    plot_scatter_metric(
        ...
        cbar_label="Sen's slope of annual HWD (days per year)",
        out_png=os.path.join(OUT_DIR, "gsod_HWD_trend_CL_1950-2024_CA_scatter.png"),
        out_pdf=os.path.join(OUT_DIR, "gsod_HWD_trend_CL_1950-2024_CA_scatter.pdf"),
        alpha_sig=0.05,
    )

    print("[OK] 6 张 GSOD HWD 散点图已重新绘制完毕。")
